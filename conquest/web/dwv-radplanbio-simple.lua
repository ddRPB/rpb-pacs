...
local seriesuid = string.gsub(CGI('seriesUID'), '^.*:', '')
...
-- Do not use webscriptadress because it is local, rather use protal as proxy
-- local urlRoot = webscriptadress
local urlRoot = proxy .. '/pacs/dicomImage.faces'
